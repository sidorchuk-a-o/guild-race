...
{
    public class ItemSlotsVMFactoriesList : ListElement<ItemSlotsVMFactory, ItemSlotsVMFactoryItem>
    {
        public override void BindData(SerializedData data)
        {
            UpdateFactoriesList(data);

            headerTitle = "Slots Factories";
        ...
        {
            var list = data.GetValue<List<ItemSlotsVMFactory>>(new());
            var types = ReflectionEditorUtils.GetTypesDerivedFrom<ItemSlotsVMFactory>();
