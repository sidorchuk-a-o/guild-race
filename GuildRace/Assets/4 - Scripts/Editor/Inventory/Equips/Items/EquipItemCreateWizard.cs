...
namespace Game.Inventory
{
    ...
    public class EquipItemCreateWizard : CreateWizard
    {
        ...
        protected override void CreateWizardGUI(VisualElement root)
        {
            ...
            rarityField = root.CreatePopup(InventoryEditorState.GetRaritiesCollection);
            rarityField.label = "Rarity";

            typeField = root.CreatePopup(InventoryEditorState.GetEquipTypesCollection);
            typeField.label = "Type";

            slotField = root.CreatePopup(InventoryEditorState.GetItemSlotsCollection);
        ...
        protected override void PreSave()
        {
            ...
            newData.SetValue("slot", new ItemSlot(slotField.value));
